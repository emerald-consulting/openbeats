              ...
              <div className="relative shadow-xl sm:rounded-2xl sm:overflow-hidden">
                ...
                <div className="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
                  ...
                  <p className="mt-6 max-w-lg mx-auto text-center text-xl text-emerald-200 sm:max-w-3xl">
                    Open Beats is a Digital Audio Workstation that makes it
                    easier for artists to collaborate on musical projects
                    remotely.
                  </p>
                  <p className="mt-6 max-w-lg mx-auto text-center text-xl text-emerald-200 sm:max-w-3xl">
                    Create a studio like experience from the comfort of your own
                    home.
                  </p>
                </div>
              </div>
            ...
            <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
              ...
              <div className="mt-6 grid grid-cols-2 gap-8 md:grid-cols-6 lg:grid-cols-5">
                ...
                <div className="col-span-1 flex justify-center md:col-span-2 lg:col-span-1">
                  <img
                    className="h-12"
                    src="https://upload.wikimedia.org/wikipedia/commons/7/78/Soundcloud_logo.svg"
                    alt="SoundCloud"
                  />
                </div>
                <div className="col-span-1 flex justify-center md:col-span-2 lg:col-span-1">
