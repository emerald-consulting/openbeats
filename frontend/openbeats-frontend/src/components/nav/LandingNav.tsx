                        ...
                        <div className=" px-5">
                            ...
                            <div className="py-6 px-5 space-y-6">
                                ...
                                <div>
                                    <a
                                        onClick={onClickSignUp}
                                        className="w-full flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-green2 hover:bg-green1 border-green"
                                    >
                                        Sign in
                                    </a>
                                    <a
