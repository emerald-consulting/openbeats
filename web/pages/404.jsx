...
const social = [
  {
    name: "Facebook",
    href: "#",
<<<<<<< HEAD:web/pages/404.jsx
    icon: (props) => (
=======
    icon: (props: any) => (
>>>>>>> 92e221aa47661ebaeeb27f8809ad5b6dcacc51c5:web/pages/404/index.tsx
      ...
      <main className="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-xl mx-auto py-16 sm:py-24">
          <div className="text-center">
            <p className="text-medium font-semibold text-white uppercase tracking-wide">
              404 error
            </p>
          ...
          <div className="mt-12">
            <h2 className="text-sm font-semibold text-green-400 tracking-wide uppercase">
              Popular pages
            </h2>
            <ul
              role="list"
            ...
            <div className="mt-8">
              <a
                href="#"
                className="text-base font-medium text-green-400 hover:text-white"
              >
