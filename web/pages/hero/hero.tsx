...
export default function Example() {
  ...
  return (
    <div>
      <NavBar />
      <main className="bg-emerald-900 sm:pb-24">
              ...
              <div>
                ...
                <h1 className="mt-4 text-4xl tracking-tight font-extrabold text-white sm:mt-5 sm:leading-none lg:mt-6 lg:text-5xl xl:text-6xl">
                  ...
                  <span className="text-green-400 md:block">
                    synchronously & remotely
                  </span>
                </h1>
                <p className="mt-3 text-base text-gray-300 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
                  Open Beats is a Digital Audio Workstation (DAW) that hopes to
                  hit a high note with mpusic artists everywhere by allowing
                  them to collaborate on projects at the same time, no matter
