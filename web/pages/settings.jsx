                ...
                <div className="pt-4 pb-3 border-t border-sky-800">
                  <div className="flex items-center px-4">
                    <div className="flex-shrink-0">
                      <img className="rounded-full h-10 w-10" src={'hero-bw.png'} alt="" />
                    </div>
                    <div className="ml-3">
                      <div className="text-base font-medium text-white">{'ryan'}</div>
                      <div className="text-sm font-medium text-sky-200">{'ryandils@buffalo.edu'}</div>
                    </div>
                    <button
                      type="button"
                  ...
                  <div className="mt-6 flex flex-col lg:flex-row">
                    ...
                    <div className="mt-6 flex-grow lg:mt-0 lg:ml-6 lg:flex-grow-0 lg:flex-shrink-0">
                      ...
                      <div className="mt-1 lg:hidden">
                        <div className="flex items-center">
                          <div
                            ...
                            aria-hidden="true"
                          >
                            <img className="rounded-full h-full w-full" src={'hero-bw.png'} alt="" />
                          </div>
                      ...
                      <div className="hidden relative rounded-full overflow-hidden lg:block">
                        <img className="relative rounded-full w-40 h-40" src={'hero-bw.png'} alt="" />
                        <label
                          htmlFor="avatar"
